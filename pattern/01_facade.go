...
Плюсы:
Позволяет проще и понятнее пользоваться и поддерживать код, т.к. все классы/структуры разграничены фасадами;
Минусы:
При отсутствии контроля фасад может стать божественным объектом, привязанным к слишком большому числу классов/структур;
*/
